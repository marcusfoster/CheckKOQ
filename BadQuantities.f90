...
! unit-correctness ALLOWS, but kind-of-quantity-correctness DETECTS, this meaningless quantity addition:
energy_final = energy_init + torque
! unit-correctness ALLOWS, but kind-of-quantity correctness DETECTS, this meaningless quantity multiplication:
